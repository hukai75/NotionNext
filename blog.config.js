...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:19186af2311a808f972ec4e2dae47780',
  THEME: (process.env.NEXT_PUBLIC_THEME || 'hexo').toLowerCase(), // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Bob', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个英国法律留子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://50hz.ai', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是中国人, Hi，我是一个留子,Hi，我喜欢Ai来减轻法律工作,欢迎来到我的博客🎉',
